        ...
        function main(Algorithm,Problem)
            ...
            while Algorithm.NotTerminated(Population)
                ...
                for i = 1 : Problem.N
                    ...
                    r1=2-Algorithm.pro.FE/size(Population,2)*((2)/Algorithm.pro.maxFE/size(Population,2));
                    ...
                    if P==i
                        Lista=B(i,:);
                        Lista = Lista(randperm(numel(Lista(~ismember(Lista,[P])))));
                        P2 = Lista(1);
                        P3 = Lista(2);
                        Offspring = OperatorSCA(Problem,Population([P,P2,P3]),Destination_position,r1,C_Iter,M_Iter);
                    else
                        Lista=B(i,:);
                        Lista = Lista(randperm(numel(Lista(~ismember(Lista,[P,i])))));
                        P2 = Lista(1);
                        Offspring = OperatorSCA(Problem,Population([i,P,P2]),Destination_position,r1,C_Iter,M_Iter);
                    end
