function Offspring = OperatorGASCAV2(Problem,Parent,Destination_position,r1)
...
%     end
	...
	if r4<0.5
        % Eq. (3.1)
        Offspring = Offspring+(r1*sin(r2)*abs(r3*repmat(Destination_position,size(Offspring,1),1)-Offspring));                                        
    else
        % Eq. (3.2)
        Offspring = Offspring+(r1*cos(r2)*abs(r3*repmat(Destination_position,size(Offspring,1),1)-Offspring));                                        
    end            
...
% 	if r4<0.5
%         % Eq. (3.1)
%         Offspring = Offspring+(r1*sin(r2)*abs(r3*Destination_position-Offspring));                
%     else
%         % Eq. (3.2)
%         Offspring = Offspring+(r1*cos(r2)*abs(r3*Destination_position-Offspring));                        
%     end
%              
%     %% Polynomial mutation
